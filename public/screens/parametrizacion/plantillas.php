...
<body style="background:transparent">
  <div class="container" style="padding:18px 20px 18px">
    <div class="breadcrumbs">Parametrización / Plantillas de comunicación</div>
    <h2 class="section">Plantillas de comunicación</h2>

    <div class="card">
      <div class="toolbar">
        <input style="max-width:280px" placeholder="Buscar por nombre o canal">
        <select>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td>Acuerdo de pago flexible</td>
            <td>SMS</td>
            <td>2025-08-04</td>
            <td>Juan García</td>
            <td><a href="#">Editar</a></td>
          ...
          <tr>
            <td>Aviso preventivo de mora</td>
            <td>WhatsApp / SMS</td>
            <td>2025-08-03</td>
            <td>Equipo de cartera</td>
            <td><a href="#">Editar</a></td>
          ...
          <tr>
            <td>Promesa de pago registrada</td>
            <td>WhatsApp / Email</td>
            <td>2025-08-01</td>
            <td>Equipo de cartera</td>
            <td><a href="#">Editar</a></td>
    ...
    <div class="grid grid-2" style="margin-top:18px;gap:18px">
      ...
      <div class="card" style="padding:22px">
        <h3 style="margin-top:0">Plantilla: Promesa de pago registrada</h3>
        <p style="color:#4b5563;line-height:1.6">Hola {{responsable}}, dejamos registrada la promesa de pago por {{valor}} para el {{fecha_limite}}. Te acompañaremos con recordatorios y soporte para que el proceso sea sencillo.</p>
        <div class="toolbar" style="margin-top:18px">
          <span class="badge">WhatsApp</span>
          <span class="badge">Email</span>
          <span style="flex:1"></span>
          <a class="btn secondary">Duplicar</a>
          <a class="btn">Enviar ahora</a>
        </div>
      </div>
      <div class="card" style="padding:22px">
        <h3 style="margin-top:0">Plantilla: Escalamiento interno</h3>
        <p style="color:#4b5563;line-height:1.6">Hola {{responsable}}, escalamos tu caso con el área académica para validar beneficios para {{estudiante}}. Te estaremos informando las alternativas disponibles tan pronto recibamos respuesta.</p>
        <div class="toolbar" style="margin-top:18px">
          <span class="badge">Email</span>
          <span class="badge">Gestión interna</span>
          <span style="flex:1"></span>
          <a class="btn secondary">Compartir</a>
          <a class="btn">Editar</a>
        </div>
