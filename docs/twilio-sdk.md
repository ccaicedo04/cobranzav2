...
6. El repositorio ignora `vendor/` para que puedas actualizar la rama sin conflictos incluso si colocas el SDK manualmente. No necesitas versionar estos archivos; basta con desplegarlos en tu servidor. Si quieres rastrearlos en Git, elimina temporalmente la regla de `.gitignore` antes de hacer commit.
